...
<h3>Carton</h3>
<p>Style: <select style="float: right; width: 174px; height: 26px;" ng-model="selectedStyle" ng-value="selectedCarton.style" ng-options="x.style for x in styles"></option></select></p>
