 ...
 <tr class="heading" style="border-bottom:thin solid #000;">
   ...
   <?php
     ...
     <td ><?php echo date('d/m/y', strtotime($result['date']))?></td>
      ...
      <td style="text-align:center"><a href="?action=action&delete_entry&id=<?php echo $result['id'];?>&sku_id=<?php echo $result['sku_id'] ?>&sku=<?php echo urlencode($result['sku'])?>">X</a></td>       
  </tr>
