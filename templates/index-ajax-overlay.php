...
#overlay {
	background-image:url(Css/images/background2.png);
	color:#efefef;
	height:450px;
}
div.contentWrap {
  ...
  <form method="POST" action="send.php">
    ...
    <tbody style="text-align:left">
      ...
      <tr>
        ...
        <td><img src="Css/images/info.png" style="width:22px; height:20px" href="src_results.php?product=<?php echo $result['product_id'];?>" rel="#overlay" /></td>
         <td><a href="src_results.php?product=<?php echo $result['product_id'];?>" rel="#overlay"> details </a>
